...
function mostrar_item(item) {
    ...
    if (presente_container.getElementsByClassName('clicado').length > 0) {
        ...
        texto.innerHTML = msg + '<br>O presente não precisa ser destes sites, mas caso seja, não se esqueça de voltar aqui para nos avisar :)<br>' +
            ...
            '<a target="_blank" class="loja" href="https://www.americanas.com.br/busca/' + palavra_chave_com_hifen + '"><img src="https://imagembuscapebr-a.akamaihd.net/vitrine/logo81.gif" alt="Americanas"></a>' +
            '<a target="_blank" class="loja" href="https://search3.pontofrio.com.br/busca?q=' + palavra_chave_com_hifen + '"><img src="https://imagembuscapebr-a.akamaihd.net/vitrine/logo114286.gif" alt="Ponto Frio"></a>' +
            '<a target="_blank" class="loja" href="https://www.carrefour.com.br/busca/?termo=' + palavra_chave_sem_acentuacao + '"><img src="https://imagembuscapebr-a.akamaihd.net/vitrine/logo1154910.gif" alt="Carrefour"></a>' +
            '<a target="_blank" class="loja" href="https://www.shoptime.com.br/busca/' + palavra_chave_com_hifen + '"><img src="https://imagembuscapebr-a.akamaihd.net/vitrine/logo125.gif" alt="Shop Time"></a>' +
            ...
            '<a target="_blank" class="loja" href="https://www.pernambucanas.com.br/catalogsearch/result/?q=' + palavra_chave_com_adicao + '"><img src="https://www.pernambucanas.com.br/static/version1557978721/frontend/Innersite/pernambucanas/pt_BR/images/logo_pernambucanas.svg" alt="Pernambucanas"></a>' +
            ...
            '<a target="_blank" class="loja" href="https://www.amazon.com.br/s?k=' + palavra_chave_com_adicao + '"><img src="https://imagembuscapebr-a.akamaihd.net/vitrine/logo1161136.gif" alt="Amazon"></a>' +
